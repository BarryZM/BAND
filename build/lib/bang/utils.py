...
from bang import custom_objects
from bang.embeddings.base_embedding import Embedding
from bang.layers.crf import CRF
from bang.processors.base_processor import BaseProcessor
from bang.tasks.base_model import BaseModel
from bang.tasks.classification.base_model import BaseClassificationModel
from bang.tasks.labeling.base_model import BaseLabelingModel
...
if __name__ == "__main__":
    path = '/Users/brikerman/Desktop/python/bang/tests/classification/saved_models/' \
           'bang.tasks.classification.models/BiLSTM_Model'
