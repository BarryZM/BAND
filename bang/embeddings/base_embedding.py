...
import bang
from bang.processors import ClassificationProcessor, LabelingProcessor
...
class Embedding(object):
    ...
    def _load_saved_instance(cls,
        ...
        instance.embed_model = keras.models.model_from_json(embed_model_json_str,
                                                            custom_objects=bang.custom_objects)
    ...
    def __init__(self,
        ...
        if processor is None:
            if task == bang.CLASSIFICATION:
                self.processor = ClassificationProcessor()
            elif task == bang.LABELING:
