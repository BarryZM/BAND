...
class BaseModel(object):
    ...
    def compile_model(self, **kwargs):
        ...
        if not bang.config.disable_auto_summary:
...
if __name__ == "__main__":
    from bang.tasks.labeling import CNN_LSTM_Model
    from bang.corpus import ChineseDailyNerCorpus
