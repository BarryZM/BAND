...
from bang.layers import L, AttentionWeightedAverageLayer, KMaxPoolingLayer
...
if __name__ == "__main__":
    ...
    from bang.corpus import SMP2018ECDTCorpus

    x, y = SMP2018ECDTCorpus.load_data()

    import bang
    from bang.processors.classification_processor import ClassificationProcessor
    from bang.embeddings import BareEmbedding

    processor = ClassificationProcessor(multi_label=False)
    embed = BareEmbedding(task=bang.CLASSIFICATION, sequence_length=30, processor=processor)
