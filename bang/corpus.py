...
class ChineseDailyNerCorpus(object):
    ...
    __zip_file__name = 'http://s3.bmio.net/bang/china-people-daily-ner-corpus.tar.gz'
...
class CONLL2003ENCorpus(object):
    ...
    __zip_file__name = 'http://s3.bmio.net/bang/conll2003_en.tar.gz'
...
class SMP2018ECDTCorpus(object):
    ...
    __zip_file__name = 'http://s3.bmio.net/bang/SMP2018ECDTCorpus.tar.gz'
